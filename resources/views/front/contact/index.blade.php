        ...
        <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
          <div class="row justify-content-center">
            <div class="col-md-8 text-center">
              <h1>Contact us</h1>
              <p data-aos="fade-up" data-aos-delay="100">Do you have any questions? Please do not hesitate to contact us directly.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 mb-5"  data-aos="fade">
          ...
          action="{{ route('front.contact.send.message') }}"
          method="post">
          @csrf
        ...
        <div class="col-md-5"  data-aos="fade" data-aos-delay="100">
          ...
          <div class="p-4 mb-3 bg-white">
            ...
            <p class="mb-4"><a href="#">+33 000 000 000</a></p>

            <p class="mb-0 font-weight-bold">Email Address</p>
            <p class="mb-0"><a href="#">contact@gexpress-finance.com</a></p>
